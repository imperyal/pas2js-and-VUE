...
rtl.module("U_dcs",["System","Classes","SysUtils"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"tDCS_gen",pas.System.TObject,function () {
    this.$init = function () {
      pas.System.TObject.$init.call(this);
      this.incVal = 0;
      this.arr_10 = rtl.arraySetLength(null,0,10);
    };
    this.$final = function () {
      this.arr_10 = undefined;
    ...
    this.setIncVal = function (incVal) {
      this.incVal = incVal;
    };
    this.incAll = function () {
      var i = 0;
      for (i = 0; i <= 9; i++) {
        if (i === 0) {
          this.arr_10[i] = this.arr_10[i] + this.incVal}
         else this.arr_10[i] = this.arr_10[i - 1] + this.incVal;
      };
    };
    this.getArrayNums = function () {
      var Result = rtl.arraySetLength(null,0,10);
      Result = this.arr_10;
      return Result;
    };
  });
});
rtl.module("program",["System","JS","Classes","SysUtils","U_dcs"],function () {
  "use strict";
  var $mod = this;
  this.pubGen = null;
  this.dummy = undefined;
  this.getNumStr = function () {
    var Result = "";
    var arr10 = rtl.arraySetLength(null,0,10);
    pas.System.Writeln("getNumStr was called.");
    arr10 = $mod.pubGen.getArrayNums();
    Result = pas.SysUtils.IntToStr(arr10[0]);
    return Result;
  };
  $mod.$main = function () {
    $mod.pubGen = pas.U_dcs.tDCS_gen.$create("Create");
    $mod.pubGen.init();
    $mod.pubGen.setIncVal(5);
    $mod.pubGen.incAll();
    $mod.dummy = $mod.getNumStr;
  };
});
